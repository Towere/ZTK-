...
<template>
  <div id="student">
    <el-row class="padding-50">
      <el-col :span="24">
        <ul class="list">
          <li class="logo"><Icon icon="solar:test-tube-bold-duotone"/><span>ZhiTK</span></li>
          <li><router-link to="/student" v-on:click="examClick">我的试卷</router-link></li>
          <li><router-link to="/practice" v-on:click="practiceClick">我的练习</router-link></li>
          ...
          <li class="right" @mouseenter="flag = !flag" @mouseleave="flag = !flag">
            <a href="javascript:;"><Icon icon="solar:accessibility-linear"/>{{user.userName}}</a>
...
export default {
  ...
  methods: {
    ...
    practiceClick() { //跳转练习模式
      let isPractice = true
      this.$store.commit("practice", isPractice);
      // this.$router.push({path:'mypractice'});
    },
    examClick() {//跳转到考试页面，实际还是首页
